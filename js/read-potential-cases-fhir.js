...
(async () => {
  ...
  await fs.writeFile("musculoskeletal-paininjury-in-adults-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("musculoskeletal-paininjury-in-adults-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
